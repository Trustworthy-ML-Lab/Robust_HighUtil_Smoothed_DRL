...
function scan_attacks () {
    ...
    $semcmd python test.py --config-path "$config" --attack-advpolicy-network "$model" --load-model "$agent_model" --attack-method paadvpolicy --deterministic $FULL_ATTACK_EXTRAS ">" "${output_dir}/optatk_deterministic.log" 
